...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="h-96 animate-pulse rounded-xl border bg-muted" />}>
      <LoginForm />
    </Suspense>
  );
}
...
function LoginForm() {
  ...
  const [formError, setFormError] = useState(error ? "Invalid email or password" : "");
  ...
  return (
    <div className="rounded-xl border bg-card p-8 shadow-sm">
      <div className="mb-6 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Sign in to your FORGE account</p>
      </div>
